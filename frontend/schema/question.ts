export const question = {
  ...
  properties: {
    ...
    hide_if: {
      ...
      type: "boolean",
      title:
        "Hide or show if answer equals hide value? Indicates the branching behaviour. If true, the element will disappear if the value of the question equals hide_value. If false, the element will appear appear instead.",
      description:
        "Indicates the branching behaviour. If true, the element will disappear if the value of the question equals hide_value. If false, the element will appear appear instead.",
      default: false,
      examples: [true],
    },
    rand_group: {
