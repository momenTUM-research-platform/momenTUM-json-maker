...
if (/Firefox\/\d+[\d\.]*/.test(navigator.userAgent) &&
    ...
    (function () {
        ...
        var me = Object.getOwnPropertyDescriptors(window.MouseEvent.prototype), ue = Object.getOwnPropertyDescriptors(window.UIEvent.prototype);
...
(0, immer_1.enableMapSet)(); // Needed for immer to be able to use Maps
